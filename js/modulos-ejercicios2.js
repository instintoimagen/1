...
ejercicios = "Video 35 ejercicios 2  \n\nEjercicio 5\n";
ejercicios += `Programa una función que invierta las palabras de una cadena de texto, pe. miFuncion("Hola Mundo") devolverá "odnuM aloH".\n\n`;
...
// Aquí ejecuntamos el listado de "misPelis" con su ficha técnica:
misPelis.forEach((el) => new Pelicula(el).fichaTecnica());

$root.innerText = ejercicios;
